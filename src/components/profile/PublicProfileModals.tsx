...
function FriendButton({
  ...
  const config = (() => {
    switch (state) {
      ...
      case 'pending_in':
        return { label: 'Akceptuj zaproszenie', cls: 'bg-orange-600 text-white hover:bg-orange-700', disabled: false };
      default:
        return { label: '+ Dodaj znajomego', cls: 'bg-orange-600 text-white hover:bg-orange-700', disabled: false };
    }
  })();
  return (
    <button
